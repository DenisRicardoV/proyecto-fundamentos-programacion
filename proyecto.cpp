...
#define PASS1 "macion"
#define USER2 "juan"
#define PASS2 "15121001"
#define p1 "Juan_Manuel_Delgado_Marcos"
#define p2 "Manuel_Alejandro_Delgado_Marcos"
using namespace std;
...
case '2': 
d=0.20;
cout<<"\n\n...Flicitaciones tiene un 20% de descuento por ser un cliene frecuente Emoticono tongue. ";
cout<<"\n\n\n DNI: ";cin>>dni;
if(dni==77344460){
cout<<"\n\n NOMBRE : "<<p1;
}
